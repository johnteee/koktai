...
```jsonc
{
  ...
  "han": {
    "八": {
      "mandarin": ["ㄅㄚ", "ㄅㄚˊ"],
      "taigi": [ { "tl": "peh4", "bopo": ["ㄅㄚㆵ", "ㄅㄨㆤㆷ", "ㄅㆤㆷ"], "poj": ["peh"],
                   "registers": ["語"], "n": 104, "w": 180,
                   "attest": ["iT","教","日","比","線"],     // 無佐證則省略此欄
                   "dialects": ["中漳","南混","蘭漳","高混"],  // 無腔別資料則省略
                   "sources": ["01:八(台甘)", "01:八", "01:八方", …] } ],  // 按 w 降冪
  ...
  "tl": {
    "pat4": [ { "han": "八", "n": 36, "w": 136,
                "attest": ["iT","教","日","植","比","甘","甘文","線","金"], … },
              { "han": "捌", "n": 4, "w": 118, … },
              { "han": "識", "n": 104, "w": 114, "attest": ["日"], "registers": ["語"] }, … ]
  }
}
```
...
- 反查韻類完整：`hong5 → 皇防黃妨紅縫逢凰惶癀蓬航鴻馮…`（55 字）。
